...
/*   Updated: 2023/10/19 17:33:02 by mfinette         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	cout << "ClapTrap constructor called: " << name << endl;
}

ClapTrap::~ClapTrap()
{
	cout << "ClapTrap Destructor called: " << this->_name << endl;
}

ClapTrap::ClapTrap(const ClapTrap & src)
{
	*this = src;
	cout << "ClapTrap Copy constructor called: " << this->_name << endl;
}
